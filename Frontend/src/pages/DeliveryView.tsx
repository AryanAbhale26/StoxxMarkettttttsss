...
const DeliveryView = () => {
  ...
  const handleExecute = async () => {
    if (!id || !confirm('Execute this delivery? Stock levels will be updated.')) {
      return;
    }
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-900">Delivery: {delivery.reference}</h2>
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-900">{delivery.reference}</p>
              </div>
              <div>
              ...
              {delivery.executed_at && (
                <div>
                  ...
                  <p className="text-gray-900">{new Date(delivery.executed_at).toLocaleString()}</p>
                </div>
              )}
            </div>
            {delivery.notes && (
